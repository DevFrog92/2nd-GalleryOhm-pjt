<template>
  <div class="sub_create_gallery_wrap">
    ...
    <div class="d_save_btn_container">
      ...
      <div slot="body" v-if="!register_state">
        ...
        <div class="desc_of_gallery">
          ...
          <textarea
            type="textarea"
            id="gallery_desc"
            placeholder="전시관 소개글을 작성해 주세요."
            v-model="gallery_desc"
          ></textarea>
        </div>
      </div>
      ...
      <div slot="body" v-if="modify_state">
        <div class="name_of_gallery">
          ...
          <input
            ...
            id="gallery_name"
            placeholder="전시관 이름을 작성해 주세요."
            v-model="gallery_info.gallery_name"
          />
        </div>
        <div class="desc_of_gallery">
          <label for="gallery_desc"></label>
          <textarea
            ...
            id="gallery_desc"
            placeholder="전시관 소개글을 작성해 주세요."
            v-model="gallery_info.gallery_desc"
          ></textarea>
        </div>
      </div>
      <div slot="body" v-else>
...
export default {
  ...
  methods: {
    ...
    clickEventHandler(e) {
      e.preventDefault();
      const emptyContainer = document.querySelectorAll(
        ".sub_carousel__slider .empty"
      );
