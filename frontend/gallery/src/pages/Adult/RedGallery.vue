        ...
        methods: {
            shred() {
                this.shredding = anime(
                    {targets: '#original', height: 0, duration: 10000, easing: 'linear'}
                )

                this.dropping = anime(
                    {targets: '#painting', translateY: '101%', duration: 10000, easing: 'linear'}
                )
            },
            click() {
                console.log("click!!")
                router.push('/RedGallery/AdultPage');
            }
        },
        mounted() {
            this.shred()
