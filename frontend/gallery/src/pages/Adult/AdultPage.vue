...
export default {
  ...
  data() {
    return {
      ...
      sampleList: [
        { sample: require("../../assets/images/d1.png") },
        { sample: require("../../assets/images/d2.png") },
        { sample: require("../../assets/images/d3.png") },
        { sample: require("../../assets/images/d5.png") },
        { sample: require("../../assets/images/d6.jpg") },
        { sample: require("../../assets/images/d7.png") },
        { sample: require("../../assets/images/d6.jpg") },
      ],
      sampleList2: [
        { sample: require("../../assets/images/d6.jpg") },
