        ...
        <ul class="about_content">
          ...
          <li class="active">
            <div class="aboutgallery">
              ...
              <p class="aboutgallery_info2">
                그림을 사랑하는 모두를 위한 공간을 만들고자하는 마음에서 시작된 '갤러리 Ω,'는<br>모두 아티스트가 될 수 있는 공간, 아티스트와 게스트 모두를 위한 공간으로 성장할 것입니다. </p>
              <p class="aboutgallery_info3">
                누구나 나만의 전시회를 열 수 있는 공간, 집에서도 전시회를 즐길 수 있는 공간
              </p>
              <p class="aboutgallery_info3_1">
                비대면 온라인 미술 작품 전시관
                <br>'갤러리 Ω,' </p>
          ...
          <li>
            <div class="aboutteam">
              ...
              <div class="aboutteam_yj"><img src="../assets/images/yj.png" alt=""></div>
              <div class="aboutteam_mj"><img src="../assets/images/mj.png" alt=""></div>
              <div class="aboutteam_ys"><img src="../assets/images/ys.png" alt=""></div>
            </div>
          </li>

          <li>
            <div class="aboutsupport">
              <p class="support_info_1"><img src="../assets/images/갤러리옴로고.png" alt="">은 그림을 그리고 싶으나 경제적 여건이 힘든 아이들을 후원하고 있습니다.</p>
              <p class="support_info_2">저희와 뜻을 함께하는 분들의 후원을 받고 있습니다.</p>
              <img src="../assets/images/gallerykakaopay.jpg" alt="">

              <p class="support_info_3">이 후원금은 다음의 용도로 사용됩니다.</p>
              <p class="support_info_4">경제적 여건으로 인해 미술대학 진학에 어려움을 겪는 학생<br>저소득층 아이들 그림 용품<br>그림공부를 위해 도움이 필요한 아이들</p>
              <p class="support_info_5"># 사용내역은 매년 1월1일 공개됩니다 #</p>
            </div>
          </li>
            ...
            <div class="aboutcontact">
              ...
              <div class="contactUs">
                <div class="contactUs_header">
                  ...
                  <div class="contactUs_header_right">
                    <div class="contactUs_header_ellipsis"></div>
                    <div class="contactUs_header_ellipsis"></div>
                    <div class="contactUs_header_ellipsis"></div>
                  </div>
                </div>
              ...
              <p class="contactinfo">사진이나 영상을 첨부하시는 분은 아래 카카오톡 오픈채팅방 혹은 이메일을 통해 메세지를 보내주세요.</p>
              <div class="contactinfo2">
                <div class="contact_kakao"><img src="../assets/images/openchat.jpg" alt=""></div>
                <!--           메일 추후 변경-->
                <a class="mail" href="mailto:hlery1206@naver.com"><img src="../assets/images/mail.png" alt=""></a>
              </div>
...
import init from '../assets/js/About'
