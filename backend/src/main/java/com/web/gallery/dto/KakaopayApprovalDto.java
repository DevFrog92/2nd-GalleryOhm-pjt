...
public class KakaopayApprovalDto {
    ...
    public KakaopayApprovalDto(String aid, String tid, String cid, String sid, String partner_order_id, String partner_user_id, String payment_method_type, AmountDto amount, CardDto card_info, String item_name, String item_code, String payload, int quantity, int tax_free_amount, int vat_amount, Date created_at, Date approved_at) {
        this.aid = aid;
        this.tid = tid;
        this.cid = cid;
        this.sid = sid;
